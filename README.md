...
It is one of the main principles that the apllication does not contain any assets that could cause copyright infringement so please do not create any requests about adding runemark icons or default rules and keywords.
...
Run `ng build` to build the project. The build artifacts will be stored in the `docs/` directory which is also the release directory.
